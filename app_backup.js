...
const HomeDashboard = ({ balance, onNavigate, recentTransactions, currencyMode, onCurrencyChange, onShowTopupDepth2 }) => {
    ...
    return (
        <div className="page">
            ...
            <div className="material-card chart-card">
                <StableCoinChart />
            </div>
...
const TopupDepth2 = ({ onNavigate, onTopup, balance, currencyMode, onCurrencyChange, onClose }) => {
    ...
    return (
        <div className="modal-overlay" onClick={(e) => {
            ...
            <div className={`modal-popup ${isClosing ? 'slide-out' : ''}`}>
            ...
            <div className="form-container">
                ...
                <div className="material-card">
                    <div style={{ textAlign: 'center' }}>
                        ...
                        <div style={{ fontSize: '36px', fontWeight: 'bold', color: '#3f51b5', marginBottom: '4px' }}>
                            €{paymentAmount}
                        </div>
...
// Profile Component
const Profile = ({ onNavigate, balance, currencyMode, onCurrencyChange }) => {
...
const App = () => {
    ...
    return (
        <div className="app-container">
            {renderPage()}
            {isLoggedIn && currentPage !== 'splash' && currentPage !== 'login' && currentPage !== 'signup' && !showTopupDepth2 && (
